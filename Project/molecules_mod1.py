...
class MRNA(Polymer):
    def __init__(self, mid, name, sequence, mass=0, count=0):
...
class Gene(BioMoleculeCount):
    def __init__(self, mid, name, sequence, count=0):
        super(Gene, self).__init__(mid, name, count)
...
class Polymerase(BioMoleculeCount):
    ...
    """
    def __init__(self, mid, name, TransRate, GeneID, count=0):
        super(Polymerase, self).__init__(mid, name, count)
    ...
    @GeneID.setter
    def GeneID(self, value):
        self.__GeneID = npr.randint(1,470)

    @TransRate.setter
    def TransRate(self, value):
        self.__TransRate = 41
